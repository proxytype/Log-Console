    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length < 2)
            {
                ...
                Console.WriteLine("Command Line Log Injection");
                Console.WriteLine("<Payload Path> <Process Name>");
                Console.WriteLine("Write log to file in tmp folder");
                Console.WriteLine("Example:");
                Console.WriteLine("C:\\payload.dll cmd");
            ...
            if (ps.Length != 0)
            {
                ...
                {
                    if (ps[i].Id != current.Id) {
                        injectDLL(ps[i].Id, payload);
                    }
                }
